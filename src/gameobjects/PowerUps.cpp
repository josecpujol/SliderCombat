...
PowerUp::PowerUp(GameObjectType type, const glm::vec2& pos) : GameObject(type, glm::vec3(pos, 0.0f), 0.0f, 0.0f) {
  ...
  base_model_.setOpenGlProgram(ResourcesManager::getInstance().getOpenGlProgram(OpenGlProgramType::kMesh3dLighting));
  ...
  powerup_model_.setOpenGlProgram(ResourcesManager::getInstance().getOpenGlProgram(OpenGlProgramType::kMesh3dLighting));
